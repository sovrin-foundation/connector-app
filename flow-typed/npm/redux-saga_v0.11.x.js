...
declare module 'redux-saga' {
  ...
  declare type SagaSpread<Y: IOEffect, R, N, T> = (
    ...args: Array<T>
  ) => Generator<Y, R, N>
  ...
  declare type Saga2<Y: IOEffect, R, N, T1, T2> = (
    t1: T1,
    t2: T2
  ) => Generator<Y, R, N>
  declare type Saga3<Y: IOEffect, R, N, T1, T2, T3> = (
    t1: T1,
    t2: T2,
    t3: T3
  ) => Generator<Y, R, N>
  declare type Saga4<Y: IOEffect, R, N, T1, T2, T3, T4> = (
    t1: T1,
    t2: T2,
    t3: T3,
    t4: T4
  ...
  declare type TakeXFn = (<Y, R, N, Fn: Saga0<Y, R, N>>(
    pattern: Pattern,
    saga: Fn
  ) => TakeXRet) &
    (<T1, Y, R, N, Fn: Saga1<Y, R, N, T1>>(
      pattern: Pattern,
      saga: Fn,
      t1: T1
    ) => TakeXRet) &
    ...
    (<
      ...
      R,
      N,
      Fn: Saga6<Y, R, N, T1, T2, T3, T4, T5, T6>
    >(
      pattern: Pattern,
      saga: Fn,
      t1: T1,
  ...
  declare type MiddlewareRunFn = (<Y, R, N, Fn: SagaList<Y, R, N>>(
    saga: Fn
  ) => Task) &
...
declare module 'redux-saga/effects' {
  ...
  declare type SelectFn3<T1, T2, T3> = (
    state: any,
    t1: T1,
    t2: T2,
    t3: T3
  ) => any
  declare type SelectFn4<T1, T2, T3, T4> = (
    state: any,
    t1: T1,
    t2: T2,
    t3: T3,
  ...
  declare type SelectFn5<T1, T2, T3, T4, T5> = (
    state: any,
    t1: T1,
    t2: T2,
    t3: T3,
  ...
  declare type SelectFn6<T1, T2, T3, T4, T5, T6> = (
    state: any,
    t1: T1,
    t2: T2,
    t3: T3,
  ...
  declare type CallEffect4<C, Fn, T1, T2, T3, T4> = CallEffect<
    C,
    Fn,
    [T1, T2, T3, T4]
  >
  declare type CallEffect5<C, Fn, T1, T2, T3, T4, T5> = CallEffect<
    C,
    Fn,
    [T1, T2, T3, T4, T5]
  >
  declare type CallEffect6<C, Fn, T1, T2, T3, T4, T5, T6> = CallEffect<
    C,
    Fn,
    [T1, T2, T3, T4, T5, T6]
  >
  ...
  declare type ForkEffect4<C, Fn, T1, T2, T3, T4> = ForkEffect<
    C,
    Fn,
    [T1, T2, T3, T4]
  >
  declare type ForkEffect5<C, Fn, T1, T2, T3, T4, T5> = ForkEffect<
    C,
    Fn,
    [T1, T2, T3, T4, T5]
  >
  declare type ForkEffect6<C, Fn, T1, T2, T3, T4, T5, T6> = ForkEffect<
    C,
    Fn,
    [T1, T2, T3, T4, T5, T6]
  >
  ...
  declare type CpsEffect4<C, Fn, T1, T2, T3, T4> = CpsEffect<
    C,
    Fn,
    [T1, T2, T3, T4]
  >
  declare type CpsEffect5<C, Fn, T1, T2, T3, T4, T5> = CpsEffect<
    C,
    Fn,
    [T1, T2, T3, T4, T5]
  >
  declare type CpsEffect6<C, Fn, T1, T2, T3, T4, T5, T6> = CpsEffect<
    C,
    Fn,
    [T1, T2, T3, T4, T5, T6]
  >
  ...
  declare type SpawnEffect3<C, Fn, T1, T2, T3> = SpawnEffect<
    C,
    Fn,
    [T1, T2, T3]
  >
  declare type SpawnEffect4<C, Fn, T1, T2, T3, T4> = SpawnEffect<
    C,
    Fn,
    [T1, T2, T3, T4]
  >
  declare type SpawnEffect5<C, Fn, T1, T2, T3, T4, T5> = SpawnEffect<
    C,
    Fn,
    [T1, T2, T3, T4, T5]
  >
  declare type SpawnEffect6<C, Fn, T1, T2, T3, T4, T5, T6> = SpawnEffect<
    C,
    Fn,
    [T1, T2, T3, T4, T5, T6]
  >
  ...
  declare type SelectEffect4<Fn, T1, T2, T3, T4> = SelectEffect<
    Fn,
    [T1, T2, T3, T4]
  >
  declare type SelectEffect5<Fn, T1, T2, T3, T4, T5> = SelectEffect<
    Fn,
    [T1, T2, T3, T4, T5]
  >
  declare type SelectEffect6<Fn, T1, T2, T3, T4, T5, T6> = SelectEffect<
    Fn,
    [T1, T2, T3, T4, T5, T6]
  >
   ...
   * APPLY STUFF
   */
  declare type ApplyFn = (<R, C: Context, Fn: Fn0<R>>(
    c: C,
    fn: Fn,
    ...rest: Array<void>
  ) => CallEffect0<C, Fn>) &
    (<T1, R, C: Context, Fn: Fn1<T1, R>>(
      c: C,
      fn: Fn,
      t1: T1,
      ...rest: Array<void>
   ...
   * CALL STUFF
   */
  declare type ContextCallFn = (<R, C: Context, Fn: Fn0<R>>(
    cfn: [C, Fn],
    ...rest: Array<void>
  ) => CallEffect0<C, Fn>) &
    (<T1, R, C: Context, Fn: Fn1<T1, R>>(
  ...
  declare type CallFn = ContextCallFn &
    ...
    (<T1, T2, R, Fn: Fn2<T1, T2, R>>(
      ...
      t1: T1,
      t2: T2
    ) => CallEffect2<null, Fn, T1, T2>) &
    (<T1, T2, T3, R, Fn: Fn3<T1, T2, T3, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
      t3: T3
    ) => CallEffect3<null, Fn, T1, T2, T3>) &
   ...
   * FORK STUFF
   */
  declare type ContextForkFn = (<R, C: Context, Fn: Fn0<R>>(
    cfn: [C, Fn],
    ...rest: Array<void>
  ) => ForkEffect0<C, Fn>) &
    (<T1, R, C: Context, Fn: Fn1<T1, R>>(
  ...
  declare type ForkFn = ContextForkFn &
    ...
    (<T1, R, Fn: Fn1<T1, R>>(
      ...
      t1: T1,
      ...rest: Array<void>
    ) => ForkEffect1<null, Fn, T1>) &
    (<T1, T2, R, Fn: Fn2<T1, T2, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
      ...rest: Array<void>
    ) => ForkEffect2<null, Fn, T1, T2>) &
    (<T1, T2, T3, R, Fn: Fn3<T1, T2, T3, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
   ...
   * CPS STUFF
   */
  declare type ContextCpsFn = (<R, C: Context, Fn: Fn0<R>>(
    cfn: [C, Fn],
    ...rest: Array<void>
  ) => CpsEffect0<C, Fn>) &
    (<T1, R, C: Context, Fn: Fn1<T1, R>>(
  ...
  declare type CpsFn = ContextCpsFn &
    ...
    (<T1, R, Fn: Fn1<T1, R>>(
      ...
      t1: T1,
      ...rest: Array<void>
    ) => CpsEffect1<null, Fn, T1>) &
    (<T1, T2, R, Fn: Fn2<T1, T2, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
      ...rest: Array<void>
    ) => CpsEffect2<null, Fn, T1, T2>) &
    (<T1, T2, T3, R, Fn: Fn3<T1, T2, T3, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
  ...
  declare type SpawnFn = ContextSpawnFn &
    ...
    (<T1, R, Fn: Fn1<T1, R>>(
      ...
      t1: T1,
      ...rest: Array<void>
    ) => SpawnEffect1<null, Fn, T1>) &
    (<T1, T2, R, Fn: Fn2<T1, T2, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
      ...rest: Array<void>
    ) => SpawnEffect2<null, Fn, T1, T2>) &
    (<T1, T2, T3, R, Fn: Fn3<T1, T2, T3, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
   ...
   * SELECT STUFF
   */
  declare type SelectFn = (<Fn: SelectFn>(
    selector: Fn,
    ...rest: Array<void>
  ) => SelectEffect0<Fn>) &
    (<T1, Fn: SelectFn1<T1>>(
    ...
    (<T1, T2, Fn: SelectFn2<T1, T2>>(
      selector: Fn,
      t1: T1,
      t2: T2,
      ...rest: Array<void>
    ) => SelectEffect2<Fn, T1, T2>) &
