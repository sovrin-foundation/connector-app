...
htmlhelp_basename = 'SovrinConnectorAppdoc'
...
latex_documents = [
    (master_doc, 'SovrinConnectorApp.tex', 'Sovrin Connector App Documentation',
     'Sovrin Foundation', 'manual'),
]
...
man_pages = [
    (master_doc, 'sovrinconnectorapp', 'Sovrin Connector App Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SovrinConnectorApp', 'Sovrin Connector App Documentation',
     author, 'SovrinConnectorApp', 'One line description of project.',
     'Miscellaneous'),
]
