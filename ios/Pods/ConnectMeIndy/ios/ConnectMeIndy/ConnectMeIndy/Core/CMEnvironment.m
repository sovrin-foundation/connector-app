...
+ (NSString *)poolName
{
    return @"connectMePool";
}

+ (NSString *)walletName
{
    return @"connectMeWallet";
}
...
+ (void) cleanupStorage
{
    NSMutableString *path = [CMEnvironment getUserDocumentDir];
...
+ (NSString *)defaultNodesConfig
{
    ...
    NSString *genesisTXNs = [nodesArray componentsJoinedByString:@"\n"];
